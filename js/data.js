...
const WC2026 = (() => {
  ...
  const FIXTURES_RAW = [
    ...
    {id:79,  stage:'r32', group:null,
      ...
      awayDesc:'Best 3rd-place team from\nGroups C, E, F, H or I',
      utc:'2026-07-01T02:00:00Z', venue:'Mexico City'},
    ...
    // ── ROUND OF 16 ──────────────────────────────────────────────────────
    // NOTE: pairings corrected to match FIFA's official published bracket
    // (Match 90 = Winner 73 v Winner 75; Match 91 = Winner 76 v Winner 78; etc.)
    {id:90, stage:'r16', group:null,
      home:'Winner R32 Match 73', away:'Winner R32 Match 75',
      homeDesc:'Winner of: 2nd Group A vs 2nd Group B\n(Mexico, Korea Rep., Czechia, S. Africa, Canada, Switzerland, Bosnia & Herz., Qatar)',
      awayDesc:'Winner of: 1st Group F vs 2nd Group C\n(Netherlands, Japan, Tunisia, Sweden, Brazil, Morocco, Haiti, Scotland)',
      utc:'2026-07-04T17:00:00Z', venue:'Houston'},
    {id:89, stage:'r16', group:null,
      home:'Winner R32 Match 74', away:'Winner R32 Match 77',
      homeDesc:'Winner of: 1st Group E vs Best 3rd\n(Germany, Ivory Coast, Ecuador, Curaçao + best 3rd from Groups A/B/C/D/F)',
      awayDesc:'Winner of: 1st Group I vs Best 3rd\n(France, Norway, Iraq, Senegal + best 3rd from Groups C/D/F/G/H)',
      utc:'2026-07-04T21:00:00Z', venue:'Philadelphia'},
    {id:91, stage:'r16', group:null,
      home:'Winner R32 Match 76', away:'Winner R32 Match 78',
      homeDesc:'Winner of: 1st Group C vs 2nd Group F\n(Brazil, Morocco, Haiti, Scotland, Netherlands, Japan, Tunisia, Sweden)',
      awayDesc:'Winner of: 2nd Group E vs 2nd Group I\n(Germany, Ivory Coast, Ecuador, Curaçao, France, Norway, Iraq, Senegal)',
      utc:'2026-07-05T20:00:00Z', venue:'New York/NJ'},
    {id:92, stage:'r16', group:null,
      home:'Winner R32 Match 79', away:'Winner R32 Match 80',
      homeDesc:'Winner of: 1st Group A vs Best 3rd\n(Mexico, Korea Rep., Czechia, S. Africa + best 3rd from Groups C/E/F/H/I)',
      awayDesc:'Winner of: 1st Group L vs Best 3rd\n(England, Croatia, Ghana, Panama + best 3rd from Groups E/H/I/J/K)',
      utc:'2026-07-06T01:00:00Z', venue:'Mexico City'},
    {id:93, stage:'r16', group:null,
      home:'Winner R32 Match 83', away:'Winner R32 Match 84',
      homeDesc:'Winner of: 2nd Group K vs 2nd Group L\n(Portugal, Colombia, Uzbekistan, Congo DR, England, Croatia, Ghana, Panama)',
      awayDesc:'Winner of: 1st Group H vs 2nd Group J\n(Spain, Uruguay, Saudi Arabia, Cabo Verde, Argentina, Austria, Algeria, Jordan)',
      utc:'2026-07-06T19:00:00Z', venue:'Dallas'},
    {id:94, stage:'r16', group:null,
      home:'Winner R32 Match 81', away:'Winner R32 Match 82',
      homeDesc:'Winner of: 1st Group D vs Best 3rd\n(USA, Türkiye, Australia, Paraguay + best 3rd from Groups B/E/F/I/J)',
      awayDesc:'Winner of: 1st Group G vs Best 3rd\n(Belgium, Iran, Egypt, New Zealand + best 3rd from Groups A/E/H/I/J)',
      utc:'2026-07-07T00:00:00Z', venue:'Seattle'},
    {id:95, stage:'r16', group:null,
      home:'Winner R32 Match 86', away:'Winner R32 Match 88',
      homeDesc:'Winner of: 1st Group J vs 2nd Group H\n(Argentina, Austria, Algeria, Jordan, Spain, Uruguay, Saudi Arabia, Cabo Verde)',
      awayDesc:'Winner of: 2nd Group D vs 2nd Group G\n(USA, Türkiye, Australia, Paraguay, Belgium, Iran, Egypt, New Zealand)',
      utc:'2026-07-07T16:00:00Z', venue:'Atlanta'},
    {id:96, stage:'r16', group:null,
      home:'Winner R32 Match 85', away:'Winner R32 Match 87',
      homeDesc:'Winner of: 1st Group B vs Best 3rd\n(Canada, Switzerland, Bosnia & Herz., Qatar + best 3rd from Groups E/F/G/I/J)',
      awayDesc:'Winner of: 1st Group K vs Best 3rd\n(Portugal, Colombia, Uzbekistan, Congo DR + best 3rd from Groups D/E/I/J/L)',
      utc:'2026-07-07T20:00:00Z', venue:'New York/NJ'},

    // ── QUARTER-FINALS ───────────────────────────────────────────────────
    {id:97, stage:'qf',  group:null,
      home:'Winner R16 Match 89', away:'Winner R16 Match 90',
      homeDesc:'Winner of R16 (Jul 4, Philadelphia)\nFrom groups: E, I + best 3rd from A/B/C/D/F/G/H',
      awayDesc:'Winner of R16 (Jul 4, Houston)\nFrom groups: A, B, C, F (Mexico, Korea Rep., Canada, Switzerland, Netherlands, Brazil, Morocco...)',
      utc:'2026-07-09T20:00:00Z', venue:'Dallas'},
    {id:98, stage:'qf',  group:null,
      home:'Winner R16 Match 93', away:'Winner R16 Match 94',
      homeDesc:'Winner of R16 (Jul 6, Dallas)\nFrom groups: H, J, K, L (Spain, Uruguay, Argentina, Portugal, England...)',
      awayDesc:'Winner of R16 (Jul 7, Seattle)\nFrom groups: D, G + best 3rd from B/E/F/I/J (USA, Belgium, Iran...)',
      utc:'2026-07-10T19:00:00Z', venue:'Los Angeles'},
    {id:99, stage:'qf',  group:null,
      home:'Winner R16 Match 91', away:'Winner R16 Match 92',
      homeDesc:'Winner of R16 (Jul 5, New York/NJ)\nFrom groups: C, E, F, I (Brazil, Morocco, Germany, Netherlands, France...)',
      awayDesc:'Winner of R16 (Jul 6, Mexico City)\nFrom groups: A, L + best 3rd from C/E/F/H/I/J/K (Mexico, England...)',
      utc:'2026-07-11T21:00:00Z', venue:'New York/NJ'},
    {id:100,stage:'qf',  group:null,
      home:'Winner R16 Match 95', away:'Winner R16 Match 96',
      homeDesc:'Winner of R16 (Jul 7, Atlanta)\nFrom groups: D, G, H, J (Argentina, Spain, USA, Belgium...)',
      awayDesc:'Winner of R16 (Jul 7, New York/NJ)\nFrom groups: B, K + best 3rd from D/E/F/G/I/J/L (Portugal, Canada...)',
      utc:'2026-07-12T01:00:00Z', venue:'Boston'},

    // ── SEMI-FINALS ──────────────────────────────────────────────────────
    {id:101,stage:'sf',  group:null,
      home:'Winner QF Match 97', away:'Winner QF Match 98',
      homeDesc:'Winner of QF (Jul 9, Dallas)\nCould include: Germany, France, Brazil, Mexico, Netherlands...',
      awayDesc:'Winner of QF (Jul 9, Los Angeles)\nCould include: Spain, Argentina, Portugal, England, USA...',
      utc:'2026-07-14T23:00:00Z', venue:'Dallas'},
    {id:102,stage:'sf',  group:null,
      home:'Winner QF Match 99', away:'Winner QF Match 100',
      homeDesc:'Winner of QF (Jul 10, New York/NJ)\nCould include: Brazil, Germany, France, Morocco, England...',
      awayDesc:'Winner of QF (Jul 11, Boston)\nCould include: Argentina, Spain, Portugal, Belgium...',
